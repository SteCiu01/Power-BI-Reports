...
![undefined](https://mavenanalyticsio-upload-bucket-prod.s3.us-west-2.amazonaws.com/65253099/projects/Measures.png)Within the Hospital Attributes category, specific attributes reflecting distinct facets of the hospital's service were scrutinized. These encompassed elements such as personnel communication, premises cleanliness, and environmental tranquility. Concomitantly, the Hospital Evaluation/Promotion category encapsulated overarching assessments—namely, the Overall Hospital Rating and the Willingness to Recommend the Hospital. These latter measures were deemed comprehensive reflections of the aggregate impact of the hospital attributes.
...
![undefined](https://mavenanalyticsio-upload-bucket-prod.s3.us-west-2.amazonaws.com/65253099/projects/Correlation%202.png)As evidenced by the correlation matrix, the two measures exhibited a robust correlation coefficient of 0.876.
...
![undefined](https://mavenanalyticsio-upload-bucket-prod.s3.us-west-2.amazonaws.com/65253099/projects/Regression.png)The ensuing regression model yielded unequivocal outcomes. It elucidated a substantial portion of the observed variability, with R-squared (R2) and Adjusted R-squared values of 0.81 and 0.77 respectively. The model's robustness was underscored by a p-value nearing 0.00.
